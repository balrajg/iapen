...
$option_headings = apply_filters( 'learn-press/question/multi-rank/admin-option-headings', $option_headings, $this->id );
?>

<div class="learn-press-question" id="learn-press-question-<?php echo $this->id; ?>" data-type="multi-rank" data-id="<?php echo $this->id; ?>">
	...
	<table class="lp-sortable lp-list-options" id="learn-press-list-options-<?php echo $this->id; ?>">
		...
		<tr>
			<?php foreach ( $option_headings as $key => $text ) { ?>
				<?php
				$classes = apply_filters( 'learn-press/question/multi-rank/admin-option-column-heading-class', array( 'column-heading', 'column-heading-' . $key ) );
				?>
				<th class="<?php echo join( ' ', $classes ); ?>">
					<?php do_action( 'learn-press/question/multi-rank/admin-option-column-heading-before-title', $key, $this->id ); ?>
					<?php echo apply_filters( 'learn-press/question/multi-rank/admin-option-column-heading-title', $text ); ?>
					<?php do_action( 'learn-press/question/multi-rank/admin-option-column-heading-after-title', $key, $this->id ); ?>
				</th>
			<?php } ?>
		</tr>
			...
			<?php foreach ( $answers as $answer ): ?>
				...
				<tr class="lp-list-option lp-list-option-<?php echo $value; ?>" data-id="<?php echo $value; ?>">
					<?php foreach ( $option_headings as $heading => $title ) { ?>
						...
						$classes = apply_filters( 'learn-press/question/multi-rank/admin-option-column-class', $classes, $heading, $answer, $this->id );
						$classes = array_filter( $classes );
						$classes = array_unique( $classes );
						?>
						<?php do_action( 'learn-press/question/multi-rank/admin-option-column-' . $heading . '-content', $answer, $this->id ); ?>
						<?php do_action( 'learn-press/question/multi-rank/admin-option-columns-content', $heading, $answer, $this->id ); ?>
