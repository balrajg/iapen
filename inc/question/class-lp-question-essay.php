...
class LP_Question_Essay extends LP_Abstract_Question {
	/**
	 * Constructor
	 *
	...
	public function submit_answer( $quiz_id, $answer ) {
		...
		$questions[$quiz_id][$this->get( 'ID' )] =  trim(stripslashes_deep( $answer ));
	...
	public function admin_interface( $args = array() ) {
		ob_start();
		$view = learn_press_get_admin_view( 'meta-boxes/question/essay.php' );
		include $view;
		$output = ob_get_clean();
	...
	public function render( $args = array() ) {
		...
		$view     = learn_press_locate_template( 'content-question/essay/answer-options.php' );
		include $view;
	}
